...
namespace LLama.Native
{
	internal unsafe class SamplingApi
	{
		...
		public static void llama_sample_frequency_and_presence_penalties(SafeLLamaContext ctx, LLamaTokenDataArray candidates, llama_token[] last_tokens, ulong last_tokens_size, float alpha_frequency, float alpha_presence)
		{
		...
		public static void llama_sample_repetition_penalty(SafeLLamaContext ctx, LLamaTokenDataArray candidates, llama_token[] last_tokens, ulong last_tokens_size, float penalty)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <param name="ctx"></param>
		/// <param name="candidates">Pointer to LLamaTokenDataArray</param>
		public static void llama_sample_softmax(SafeLLamaContext ctx, LLamaTokenDataArray candidates)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		public static void llama_sample_tail_free(SafeLLamaContext ctx, LLamaTokenDataArray candidates, float z, ulong min_keep)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		public static void llama_sample_temperature(SafeLLamaContext ctx, LLamaTokenDataArray candidates, float temp)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <param name="candidates">Pointer to LLamaTokenDataArray</param>
		/// <returns></returns>
		public static llama_token llama_sample_token(SafeLLamaContext ctx, LLamaTokenDataArray candidates)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <param name="candidates">Pointer to LLamaTokenDataArray</param>
		/// <returns></returns>
		public static llama_token llama_sample_token_greedy(SafeLLamaContext ctx, LLamaTokenDataArray candidates)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <returns></returns>
		public static llama_token llama_sample_token_mirostat(SafeLLamaContext ctx, LLamaTokenDataArray candidates, float tau, float eta, int m, ref float mu)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <param name="mu">Maximum cross-entropy. This value is initialized to be twice the target cross-entropy (`2 * tau`) and is updated in the algorithm based on the error between the target and observed surprisal.</param>
		/// <returns></returns>
		public static llama_token llama_sample_token_mirostat_v2(SafeLLamaContext ctx, LLamaTokenDataArray candidates, float tau, float eta, ref float mu)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <param name="k"></param>
		/// <param name="min_keep"></param>
		public static void llama_sample_top_k(SafeLLamaContext ctx, LLamaTokenDataArray candidates, int k, ulong min_keep)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <param name="p"></param>
		/// <param name="min_keep"></param>
		public static void llama_sample_top_p(SafeLLamaContext ctx, LLamaTokenDataArray candidates, float p, ulong min_keep)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
		...
		/// <param name="p"></param>
		/// <param name="min_keep"></param>
		public static void llama_sample_typical(SafeLLamaContext ctx, LLamaTokenDataArray candidates, float p, ulong min_keep)
		{
			System.Buffers.MemoryHandle handle = candidates.data.Pin();
			LLamaTokenDataArrayNative st = new()
			{
