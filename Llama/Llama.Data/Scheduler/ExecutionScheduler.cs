using Llama.Data.Scheduler.Exceptions;
...
namespace Llama.Data.Scheduler
{
    public partial class ExecutionScheduler : IExecutionScheduler
    {
        ...
        public T Execute<T>(Func<T> action, ExecutionPriority priority)
        {
            ...
            ExecutionResult<T> result = queuedExecution.Result;
            ...
            {
                throw new AsynchronousExecutionException(result.Exception.Message, result.Exception);
            }
        }
