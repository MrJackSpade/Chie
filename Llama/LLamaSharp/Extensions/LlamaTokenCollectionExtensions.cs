...
namespace Llama.Extensions
{
    ...
    {
        public static void Append(this ILlamaTokenCollection target, IEnumerable<LlamaToken> source)
        {
        ...
        public static void AppendControl(this ILlamaTokenCollection target, IEnumerable<int> source)
        {
        ...
        public static void AppendControl(this ILlamaTokenCollection target, int id) => target.Append(new LlamaToken(id, IntPtr.Zero, Llama.Constants.LlamaTokenTags.CONTROL));
